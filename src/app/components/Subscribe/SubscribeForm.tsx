...
import ERROR from '../../assets/input_error.svg';
import Validation from '../../assets/input_validation.svg';
import { Button } from '../Button/Button';
import Image from 'next/image';

const inputStyles = 'bg-AccentBackground w-full font-light box-border border-b border-Black placeholder:text-xxxs tablet:placeholder:text-xxs placeholder:text-Black placeholder:uppercase py-4 px-0 tablet:px-6 outline-none';
  ...
  return (
    ...
    >
      {({ values, errors, handleChange, handleBlur }) => (
        <Form className="flex flex-col tablet:flex-row w-full gap-[10px] tablet:gap-10" noValidate>

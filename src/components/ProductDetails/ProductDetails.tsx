...
export default function ProductDetails({
  ...
  const publicationYear = state.fields?.find(
    (p) => p.lable_name === "Publication year"
  )?.value;
      ...
      <div className="flex flex-col desktop:flex-row gap-[135px]">
        <div className="hidden desktop:flex flex-col flex-1 border border-Black p-4 ">
          ...
          <div className="mb-2 tablet:mb-5 desktop:h-full desktop:w-full">
            <div
              className={`relative h-[212px] tablet:w-[149px] tablet:h-[220px] desktop:h-full desktop:w-full mx-auto`}
            >
              <Image
        ...
        <div className="flex flex-col flex-1 gap-10">
          ...
          <div className="border border-Black p-4 desktop:hidden">
            ...
            <div className="relative mb-2 tablet:mb-5">
              <div
                className={`relative h-[212px] tablet:w-[149px] tablet:h-[220px] mx-auto`}
              >
                <Image
                  src={image ? `${image[0]}` : plug_book}
                  alt={state ? name : ""}
          ...
          <div className="flex flex-col gap-[17px]">
            <h2 className="text-xxs tablet:text-xsx desktop:text-cartL font-bold uppercase">
              Book description
            </h2>

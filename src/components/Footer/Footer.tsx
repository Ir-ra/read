...
export const Footer = () => {
  ...
  return (
    <footer className="px-6 py-10 tablet:px-10 bottom-0 w-full bg-Background p-10">
      ...
      <Link
        href="/"
        className="flex justify-center tablet:justify-start text-[26px] leading-10 tablet:text-sm font-medium tablet:font-bold mb-8 desktop:hidden uppercase"
        onClick={scrollToTop}
      >
        Vartoread
      </Link>
      ...
      <div className="flex flex-col tablet:flex-row items-center tablet:items-start justify-center tablet:justify-between mb-10 tablet:mb-8 gap-7">
        <Link
          href="/"
          className="text-s font-bold hidden desktop:block uppercase w-full"
          onClick={scrollToTop}
        >
          Vartoread
        </Link>
        ...
        <div className="footerBoxes">
          <h3 className="footerCols">About us</h3>
        ...
        <div className="footerBoxes">
          <h3 className="footerCols">To clients</h3>
        ...
        <div className="footerBoxes">
          <h3 className="footerCols">Follow us</h3>

...
import about_us_1 from "../../../public/img/about_us/about_us_1.png";
import about_us_2 from "../../../public/img/about_us/about_us_2.png";
import about_us_3 from "../../../public/img/about_us/about_us_3.png";
import bg_about_us from "../../../public/img/about_us/bg_about_us.png";
        ...
        <ul>
          {aboutUsInfo.map((info) => {
            return (
              <li
                key={info.id}
                className="desktop:flex desktop:gap-5 items-center justify-end max-w-[327px] tablet:min-w-[436px] desktop:min-w-full mx-auto desktop:mx-0"
              >
